...
function showSelectedOperator(){
    ...
    if (operator_value == "+"){
        ...
        document.getElementById("plusOp").style.backgroundColor  = "#355f61";
    }
    else if (operator_value == "-"){
        document.getElementById("subOp").style.backgroundColor  = "#355f61";
    }
    else if (operator_value == "*"){
        document.getElementById("multiOp").style.backgroundColor  = "#355f61";
    }
    else if (operator_value == "/"){
        document.getElementById("divOp").style.backgroundColor  = "#355f61";
    }
}
